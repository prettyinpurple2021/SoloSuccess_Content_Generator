...
const IntegrationCredentialsForm: React.FC<IntegrationCredentialsFormProps> = ({
  ...
  const getCredentialFields = (platform: string, type: IntegrationType) => {
    const fields: Record<string, any> = {
      ...
      twitter: [
        { key: 'apiKey', label: 'API Key', type: 'text', required: true, placeholder: 'Enter your Twitter API Key' },
        { key: 'apiSecret', label: 'API Secret', type: 'password', required: true, placeholder: 'Enter your Twitter API Secret' },
        { key: 'accessToken', label: 'Access Token', type: 'password', required: true, placeholder: 'Enter your Access Token' },
        { key: 'accessTokenSecret', label: 'Access Token Secret', type: 'password', required: true, placeholder: 'Enter your Access Token Secret' },
        { key: 'bearerToken', label: 'Bearer Token', type: 'password', required: false, placeholder: 'Enter your Bearer Token (optional)' }
      ],
      linkedin: [
        { key: 'clientId', label: 'Client ID', type: 'text', required: true, placeholder: 'Enter your LinkedIn Client ID' },
        { key: 'clientSecret', label: 'Client Secret', type: 'password', required: true, placeholder: 'Enter your LinkedIn Client Secret' },
        { key: 'accessToken', label: 'Access Token', type: 'password', required: true, placeholder: 'Enter your Access Token' },
        { key: 'refreshToken', label: 'Refresh Token', type: 'password', required: false, placeholder: 'Enter your Refresh Token (optional)' }
      ],
      facebook: [
        { key: 'appId', label: 'App ID', type: 'text', required: true, placeholder: 'Enter your Facebook App ID' },
        { key: 'appSecret', label: 'App Secret', type: 'password', required: true, placeholder: 'Enter your Facebook App Secret' },
        { key: 'accessToken', label: 'Access Token', type: 'password', required: true, placeholder: 'Enter your Access Token' },
        { key: 'pageId', label: 'Page ID', type: 'text', required: false, placeholder: 'Enter your Page ID (optional)' }
      ],
      instagram: [
        { key: 'accessToken', label: 'Access Token', type: 'password', required: true, placeholder: 'Enter your Instagram Access Token' },
        { key: 'userId', label: 'User ID', type: 'text', required: true, placeholder: 'Enter your Instagram User ID' },
      ...
      youtube: [
        ...
        { key: 'clientSecret', label: 'Client Secret', type: 'password', required: true, placeholder: 'Enter your YouTube Client Secret' },
        { key: 'refreshToken', label: 'Refresh Token', type: 'password', required: true, placeholder: 'Enter your Refresh Token' }
      ],
      // Analytics Platforms
      google_analytics: [
        { key: 'clientId', label: 'Client ID', type: 'text', required: true, placeholder: 'Enter your Google Analytics Client ID' },
        { key: 'clientSecret', label: 'Client Secret', type: 'password', required: true, placeholder: 'Enter your Google Analytics Client Secret' },
        { key: 'refreshToken', label: 'Refresh Token', type: 'password', required: true, placeholder: 'Enter your Refresh Token' },
        { key: 'viewId', label: 'View ID', type: 'text', required: true, placeholder: 'Enter your Google Analytics View ID' }
      ],
      facebook_analytics: [
        { key: 'accessToken', label: 'Access Token', type: 'password', required: true, placeholder: 'Enter your Facebook Access Token' },
        { key: 'pageId', label: 'Page ID', type: 'text', required: false, placeholder: 'Enter your Page ID (optional)' }
      ],
      twitter_analytics: [
        { key: 'bearerToken', label: 'Bearer Token', type: 'password', required: true, placeholder: 'Enter your Twitter Bearer Token' }
      ],
      // AI Services
      openai: [
        { key: 'apiKey', label: 'API Key', type: 'password', required: true, placeholder: 'Enter your OpenAI API Key' },
        { key: 'organizationId', label: 'Organization ID', type: 'text', required: false, placeholder: 'Enter your Organization ID (optional)' }
      ],
      claude: [
      ...
      // CRM Platforms
      hubspot: [
        { key: 'apiKey', label: 'API Key', type: 'password', required: true, placeholder: 'Enter your HubSpot API Key' },
        { key: 'portalId', label: 'Portal ID', type: 'text', required: true, placeholder: 'Enter your HubSpot Portal ID' }
      ],
      salesforce: [
        { key: 'clientId', label: 'Client ID', type: 'text', required: true, placeholder: 'Enter your Salesforce Client ID' },
        { key: 'clientSecret', label: 'Client Secret', type: 'password', required: true, placeholder: 'Enter your Salesforce Client Secret' },
        { key: 'username', label: 'Username', type: 'text', required: true, placeholder: 'Enter your Salesforce Username' },
        { key: 'password', label: 'Password', type: 'password', required: true, placeholder: 'Enter your Salesforce Password' }
      ],
      // Email Platforms
      mailchimp: [
        { key: 'apiKey', label: 'API Key', type: 'password', required: true, placeholder: 'Enter your Mailchimp API Key' },
        { key: 'serverPrefix', label: 'Server Prefix', type: 'text', required: true, placeholder: 'Enter your Server Prefix (e.g., us1)' }
      ],
      sendgrid: [
        { key: 'apiKey', label: 'API Key', type: 'password', required: true, placeholder: 'Enter your SendGrid API Key' }
      ],
      // Storage Platforms
      google_drive: [
        { key: 'clientId', label: 'Client ID', type: 'text', required: true, placeholder: 'Enter your Google Drive Client ID' },
        { key: 'clientSecret', label: 'Client Secret', type: 'password', required: true, placeholder: 'Enter your Google Drive Client Secret' },
        { key: 'refreshToken', label: 'Refresh Token', type: 'password', required: true, placeholder: 'Enter your Refresh Token' }
      ],
      dropbox: [
  ...
  const getHelpText = (platform: string) => {
    const helpTexts: Record<string, string> = {
      twitter: 'Get your API credentials from the Twitter Developer Portal. You\'ll need to create a new app and generate API keys.',
      linkedin: 'Create a LinkedIn app in the LinkedIn Developer Portal to get your Client ID and Client Secret.',
      facebook: 'Create a Facebook app in the Facebook Developer Console to get your App ID and App Secret.',
      instagram: 'Use the Instagram Basic Display API. Create an app in the Facebook Developer Console.',
      google_analytics: 'Enable the Google Analytics Reporting API and create OAuth 2.0 credentials in the Google Cloud Console.',
      openai: 'Get your API key from the OpenAI platform. You can find it in your account settings.',
      claude: 'Get your API key from the Anthropic platform. Sign up for access to the Claude API.'
    };

    return helpTexts[platform] || 'Please refer to the platform\'s documentation for API credentials.';
  };
