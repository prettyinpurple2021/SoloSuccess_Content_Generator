...
const REPURPOSING_FORMATS = [
    { id: 'Video Script', name: 'Video Script', icon: '🎬', description: 'Short-form video with timing cues' },
    { id: 'Email Newsletter', name: 'Email Newsletter', icon: '📧', description: 'Email-optimized with subject lines' },
    { id: 'LinkedIn Article', name: 'LinkedIn Article', icon: '💼', description: 'Professional LinkedIn post' },
    { id: 'Podcast Script', name: 'Podcast Script', icon: '🎙️', description: 'Conversational audio script' },
    { id: 'Twitter Thread', name: 'Twitter Thread', icon: '🐦', description: 'Multi-tweet thread format' },
    { id: 'Instagram Caption', name: 'Instagram Caption', icon: '📸', description: 'Visual-focused social post' }
];
    ...
    const handleSingleRepurpose = async (format: string) => {
        ...
        try {
            const options = {
                ...
                brandVoice: customization.brandTone && customization.brandStyle ? {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) => setCustomization(prev => ({ ...prev, brandStyle: e.target.value }))}
                            className="w-full px-3 py-2 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-purple-400"
                        >
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            {result.optimizationScore && (
                                <span className={`px-2 py-1 rounded-full text-xs font-bold ${
                                    result.optimizationScore >= 80 ? 'bg-green-500/20 text-green-300' :
                                    result.optimizationScore >= 60 ? 'bg-yellow-500/20 text-yellow-300' :
