...
export const HelpSystem: React.FC<HelpSystemProps> = ({
  ...
  const articles: HelpArticle[] = [
    // Getting Started
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Welcome to the enhanced content creation features! These new tools will help you create more engaging, personalized content.</p>
          ...
          <ul className="space-y-2">
            <li className="flex items-start gap-2">
              ...
              <div>
                <strong>Brand Voice:</strong> Define your unique tone and style for consistent content
              </div>
            </li>
            <li className="flex items-start gap-2">
              <Users className="w-4 h-4 text-purple-500 mt-1" />
              <div>
                <strong>Audience Profiles:</strong> Create detailed profiles for targeted content generation
              </div>
            </li>
            <li className="flex items-start gap-2">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-blue-500 pl-4">
              ...
              <p className="text-sm text-gray-600">Go to Brand Voice Manager and create your first voice profile. This will improve all AI-generated content.</p>
            </div>
            
            <div className="border-l-4 border-purple-500 pl-4">
              <h4 className="font-medium">Step 2: Set Up Audience Profile (1 min)</h4>
              <p className="text-sm text-gray-600">Define who you're writing for in the Audience Profile Manager for more targeted content.</p>
            </div>
            
            <div className="border-l-4 border-green-500 pl-4">
              <h4 className="font-medium">Step 3: Create Your First Campaign (1 min)</h4>
              <p className="text-sm text-gray-600">Organize your content with campaigns for better coordination and tracking.</p>
            </div>
            
            <div className="border-l-4 border-red-500 pl-4">
              <h4 className="font-medium">Step 4: Generate Enhanced Content (1 min)</h4>
              <p className="text-sm text-gray-600">Create new content using your brand voice and audience profile for personalized results.</p>
            </div>
          </div>
        </div>
      )
    ...
    // Brand Voice
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Brand voice defines how your content sounds and feels to your audience. It ensures consistency across all your communications.</p>
          
          <h3 className="text-lg font-semibold">What Makes a Good Brand Voice?</h3>
          <ul className="space-y-2">
            <li><strong>Tone:</strong> Professional, casual, friendly, authoritative, etc.</li>
            <li><strong>Vocabulary:</strong> Industry terms, casual language, technical jargon</li>
            <li><strong>Style:</strong> Sentence structure, paragraph length, formatting preferences</li>
            <li><strong>Personality:</strong> Humorous, serious, encouraging, direct</li>
          </ul>

          <div className="bg-yellow-50 p-4 rounded-lg">
            <h4 className="font-medium text-yellow-900 mb-2">💡 Pro Tip:</h4>
            <p className="text-sm text-yellow-800">
              Include 3-5 sample pieces of content that represent your ideal voice. The AI will learn from these examples.
            </p>
          </div>
    ...
    // Campaigns
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Campaigns help you organize related content pieces and track their collective performance.</p>
          ...
          <div className="bg-green-50 p-4 rounded-lg">
            <div className="space-y-2">
              <div><strong>Campaign:</strong> Overall theme or goal</div>
              <div className="ml-4"><strong>↳ Content Series:</strong> Related posts within the campaign</div>
              <div className="ml-8"><strong>↳ Individual Posts:</strong> Specific content pieces</div>
            </div>
          </div>
    ...
    // Analytics
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Analytics help you understand what content works best and how to improve your strategy.</p>
          
          <h3 className="text-lg font-semibold">Key Metrics:</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-blue-50 p-3 rounded-lg">
              <h4 className="font-medium text-blue-900">Engagement Rate</h4>
              <p className="text-sm text-blue-800">Likes, shares, comments divided by impressions</p>
            </div>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg">
            ...
            <p className="text-sm text-yellow-800">
              Focus on trends rather than individual post performance. Look for patterns in your top-performing content and replicate those elements.
            </p>
          </div>
        </div>
      )
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center gap-4 text-sm text-gray-500">
                      <span className={`px-2 py-1 rounded-full ${
                        selectedArticleData.difficulty === 'beginner' ? 'bg-green-100 text-green-700' :
                        selectedArticleData.difficulty === 'intermediate' ? 'bg-yellow-100 text-yellow-700' :
                        'bg-red-100 text-red-700'
                      }`}>
            ...
            <div className="flex-1 flex items-center justify-center p-6">
              <div className="text-center max-w-md">
                ...
                <p className="text-gray-600 mb-6">
                  Select a category or search for specific topics to get started with enhanced features.
                </p>
