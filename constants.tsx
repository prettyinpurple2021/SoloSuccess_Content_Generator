...
} as const satisfies Record<string, React.FC<{ className?: string }>>;

type SocialIconKey = keyof typeof SocialIcons;

export const Plus = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 4v16m8-8H4" />
  </svg>
);

export const Trash2 = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const ArrowDown = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 16v4m0 0l-4-4m4 4l4-4" />
  </svg>
);

export const Save = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const Eye = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const Settings = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const Bug = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M12 8v4m0 4v2m6-6a2 2 0 11-4 0 2 2 0 014 0zm-12 0a2 2 0 110-4 2 2 0 010 4zm12 0h4m-2-2l2-2m-2 2l-2-2"
    />
  </svg>
);
...
export const PLATFORM_CONFIG: Record<
  SocialIconKey,
  { icon: React.FC<{ className?: string }>; charLimit?: number }
> = {
  Twitter: { icon: SocialIcons.Twitter as React.FC<{ className?: string }>, charLimit: 280 },
  LinkedIn: { icon: SocialIcons.LinkedIn as React.FC<{ className?: string }> },
  Facebook: { icon: SocialIcons.Facebook as React.FC<{ className?: string }> },
  Instagram: { icon: SocialIcons.Instagram as React.FC<{ className?: string }> },
  Threads: { icon: SocialIcons.Threads as React.FC<{ className?: string }>, charLimit: 500 },
  Bluesky: { icon: SocialIcons.Bluesky as React.FC<{ className?: string }>, charLimit: 300 },
};
