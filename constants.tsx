...
export const PLATFORMS = ['Twitter', 'LinkedIn', 'Facebook', 'Instagram', 'Threads', 'Bluesky'] as const;
...
export const ArrowDown = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M7 8v12m0 0l4-4m-4 4l-4-4" />
  </svg>
);
...
export const PLATFORM_CONFIG: Record<SocialPlatform, { icon: React.FC<{ className?: string }>; charLimit?: number }> = {
