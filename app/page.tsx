  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="sparkle sparkle-hero-3"></div>
        <div className="sparkle sparkle-hero-4"></div>
        <div className="sparkle sparkle-hero-5"></div>
        <div className="sparkle sparkle-hero-6"></div>
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-6 text-center">
        ...
        >
          <h1 className="text-6xl sm:text-8xl font-display gradient-text tracking-wider mb-8 relative">
            SoloSuccess AI
            <div className="sparkle sparkle-title-1"></div>
            <div className="sparkle sparkle-title-2"></div>
          </h1>
          ...
          >
            Transform your content creation with AI-powered planning, scheduling,
            and optimization. Build your empire with intelligent automation and
            strategic insights.
          </motion.p>
      ...
      >
        <p>
          &copy; 2024 SoloSuccess AI. Building your empire, one post at a time.
        </p>
      </motion.footer>
    </div>
  )
