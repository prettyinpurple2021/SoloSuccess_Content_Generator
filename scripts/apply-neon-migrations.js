...
if (!databaseUrl) {
  console.error('❌ Error: No database URL found. Please set VITE_NEON_DATABASE_URL or DATABASE_URL environment variable.');
  process.exit(1);
}
...
async function applyMigrations() {
  try {
    ...
    const migrationPath = path.join(__dirname, '..', 'database', 'neon-integration-schema-migration.sql');
