  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'rainbow-gradient': 'linear-gradient(45deg, #ff0080, #ff8c00, #ffd700, #00ff80, #00bfff, #8000ff, #ff0080)',
      ...
      boxShadow: {
        ...
        '3d-hover': '0 15px 40px rgba(255, 105, 180, 0.4), 0 25px 70px rgba(138, 43, 226, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.4)',
      },
      backdropBlur: {
        xs: '2px',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { 
            boxShadow: '0 0 20px rgba(255, 105, 180, 0.5), 0 0 40px rgba(255, 105, 180, 0.3), 0 0 60px rgba(255, 105, 180, 0.1)',
          },
          '50%': { 
            boxShadow: '0 0 30px rgba(255, 105, 180, 0.8), 0 0 60px rgba(255, 105, 180, 0.5), 0 0 90px rgba(255, 105, 180, 0.3)',
          },
        },
        float: {
